...
export default class Staff extends React.Component{
    ...
    requestList = ()=>{
        axios.requestList(this,'/staff/list',this.params);
    }
    handleOperate = (type)=>{
    ...
    handleSubmit = ()=>{
        ...
        axios.ajax({
            url:type=='create'?'/staff/add':'/staff/edit',
            data:{
                params:{
                    params:data
                }
        ...
        return(
            <div>
                ...
                <Card style={{marginTop:10}} className="operate-wrap">
                    ...
                    <Button type='primary' icon='delete' onClick={()=>this.handleOperate('delete')}>移除员工</Button>
                </Card>
